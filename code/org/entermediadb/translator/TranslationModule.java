...
public class TranslationModule extends BaseMediaModule
{
	...
	public TranslationManager loadTranslationManager(WebPageRequest inReq)
	{
		MediaArchive archive = getMediaArchive(inReq);
		TranslationManager manager = (TranslationManager) archive.getBean("translationManager");
		inReq.putPageValue("translationManager", manager);
		return manager;
	}

	String[] languages = new String[] {"af", "sq", "ar-DZ", "ar", "hy", "az", "eu", "bs", "bg", "ca", "zh-HK", "zh-CN", "zh-TW", "hr", "cs", "da", "nl-BE", "nl", "en-AU", "en-NZ", "en-GB", "eo", "et",
		"fo", "fa", "fi", "fr", "fr-CH", "gl", "ge", "de", "el", "he", "hi", "hu", "is", "id", "it", "ja", "kk", "km", "ko", "lv", "lt", "lb", "mk", "ml", "ms", "no", "pl", "pt", "pt-BR", "rm", "ro",
		"ru", "sr", "sr-SR", "sk", "sl", "es", "sv", "ta", "th", "tj", "tr", "uk", "vi", "cy-GB"};
