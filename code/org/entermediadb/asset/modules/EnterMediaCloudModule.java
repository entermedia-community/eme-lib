...
public class EnterMediaCloudModule extends BaseJsonModule
{
	...
	// Give it a temporary key that is generated by the server and will be
	// authenticated by the remote server as well
	public void loginUserWithExpiringKey(WebPageRequest inReq)
	{
		// createConnection
		// The adminkey will be defaulted for new sites. Once this is used once we will
		// want to change the login
		...
		if (workspaceid == null)
		{
			...
			if (!workspaceid.equals(collectionid))
			{
