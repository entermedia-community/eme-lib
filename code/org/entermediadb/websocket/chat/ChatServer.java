...
public class ChatServer
{
		...
		if (catalogid != null && channelid != null)
		{
			...
			if (channelmoduleid != null)
			{
				...
				else
				{
					...
					/*
					 * Collection<AddedPermission> permissions =
	...
	public Data saveMessage(final JSONObject inMap)
	{
		...
		String functionname = values.getString("functionname");
		chat.setValue("functionname", functionname);

		String nextfunctionname = values.getString("nextfunctionname");
		chat.setValue("nextfunctionname", nextfunctionname);
